<template>
  <div class="dropdown" :class="showItemsListClass">
    <button
      type="button"
    ...
    <div class="dropdown__menu" :class="showItemsListClass">
      <button
        ...
        :class="itemIconClass"
        type="button"
        @click="buttonHandler(option.value)"
      >
...
export default {
  ...
  computed: {
    ...
    showItemsListClass() {
      return { show: this.showItemsList };
    },
    showIcons() {
      return this.options.some(option => option.icon != null);
    },
    toggleIconClass() {
      return {dropdown__toggle_icon: this.showIcons};
    },
    itemIconClass() {
      return {dropdown__item_icon: this.showIcons};
    },
  },
